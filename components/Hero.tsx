      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <div className="my-11 flex flex-wrap gap-5">
          ...
          <p className="bold-16 lg:bold-20 text-blue-70">
            690k
            <span className="regular-16 lg:regular-20 ml-1">Extraordinary Reviews</span>
          </p>
        </div>
        <div className="flex w-full gap-3 sm:flex-row">
          <Button type="button" title="Download App" variant="btn_dark_green" />
          <Button type="button" title="How we work?" icon="/play.svg" variant="btn_dark_green" />
        </div>
      </div>
        ...
        <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          ...
          <div className="flexBetween">
            <div className="flex flex-col">
              ...
              <p className="bold-20 text-white">150.32 km</p>
            </div>
            <div className="flex flex-col">
              <p className="regular-16 block text-gray-20">Elevation</p>
              <p className="bold-20 text-white">3.030 km</p>
            </div>
          </div>
        </div>
      </div>
